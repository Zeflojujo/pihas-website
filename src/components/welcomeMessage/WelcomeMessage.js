        ...
        <div style={{clear:"both"}} id="welcome1_div">
            <div className="welcome1_list">
                <div className="welcome1_div1">
                    <div className="welcome">
                        <div className="director">
                            ...
                            <h2 className="h2">DR. MUSIKA KM</h2>
                ...
                {/* <p style={{marginTop:"0px", marginLeft:"5px", marginBottom:"0", fontWeight:"bold", padding:"3px"}}><a href="downloadxpsqds/57" className="ck">MAELEZO YA MUOMBAJI (AFYA) NEW 2023/2024</a></p> */}
                            ...
                            <div className="more"><a href="News-and-events">More Downloads</a></div>
                        </div>
                        <div>
                            ...
                            <div className="more"><a href="News-and-events">More news</a></div>
                        </div>
                    </div>
                </div>
            </div> 
